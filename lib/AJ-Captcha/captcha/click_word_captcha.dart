...
import 'package:nbut_take_out/AJ-Captcha/request/HttpManager.dart';
import 'package:nbut_take_out/AJ-Captcha/request/encrypt_util.dart';
import 'package:nbut_take_out/AJ-Captcha/tools/object_utils.dart';
import 'package:nbut_take_out/AJ-Captcha/tools/widget_util.dart';
...
class _ClickWordCaptchaState extends State<ClickWordCaptcha> {
  ...
  _checkCaptcha() async {
    ...
    if (!ObjectUtils.isEmpty(_clickWordCaptchaModel.secretKey)) {
      cryptedStr = EncryptUtil.aesEncode(
          key: _clickWordCaptchaModel.secretKey, content: pointStr);
      var dcrypt = EncryptUtil.aesDecode(
...
//    Map _map = json.decode(dcrypt);
  ...
  _checkSuccess(String pointJson) async {
    ...
    var cryptedStr = EncryptUtil.aesEncode(key: 'BGxdEUOZkXka4HSj', content: pointJson);
